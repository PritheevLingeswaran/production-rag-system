...
Production-style RAG system with a FastAPI backend. The app supports document upload, grounded Q&A with citations, summaries, and settings APIs.
...
The FastAPI backend uses `x-api-key` when API-key auth is enabled.
